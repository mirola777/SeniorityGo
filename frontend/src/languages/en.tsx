function English() {
    return {
        translation: {
            ...
            create_profile_advice: "Remember that you can't create a Profile with a name that already exists within the organization",
            ...
            recently_created_profiles: "Recently created Profiles",
            ...
            no_profiles: "There are no profiles created yet, create one now!",
            ...
            delete_profile_sure: "Are you sure you want to delete this profile?",
            select_a_pokemon: "Select a Pokemon",
            select_requirements: "Select requirements",
            update_profile: "Update Profile",
            profile_page: "This is a Profile, an organization always will have different profiles, each with a name, many Seniority levels, and a description. The profiles are used to represent the people who work in the organization. For example, a profile can be a developer named John Doe, with a Seniority level of Senior, and a description of 5 years of experience in the company. Every Seniority Level has a Pokemon that represents it. When you reach a Seniority Level, you will get the Pokemon of that level.",
        },
    };
}
