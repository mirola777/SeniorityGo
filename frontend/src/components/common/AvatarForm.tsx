...
function AvatarForm() {
    ...
    return (
        <div className="flex flex-col items-center justify-center mx-auto md:h-full">
            <div className="w-full rounded-lg border px-4 sm:px-6 py-2 md:mt-0 sm:max-w-md  bg-gradient-to-r border-b border-blue-800 from-gray-800 to-dark-blue-800 shadow-2xl">
                <form className='w-full mx-auto space-y-4 flex flex-col' onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 justify-between">
                        ...
                        <Link to="/" className="inline-block rounded-full bg-gradient-to-r from-red-700 to-red-600 p-[4px] text-white focus:outline-none focus:ring active:text-opacity-75">
                            <span
                                className="text-center block rounded-full bg-dark-blue-800/60 px-8 py-2 text-sm font-medium hover:bg-dark-blue-800/40">
                                {t('skip')}
                            </span>
                        </Link>
                    </div>
