    ...
    return (
        <div>
            ...
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto scrollbar-none fixed inset-0 z-40 outline-none focus:outline-none">
                <div className="relative w-3/4 my-6 mx-auto max-w-7xl ">
                    <div className='w-full h-full flex-col flex rounded-lg bg-gradient-to-r from-gray-800 to-dark-blue-800 shadow-2xl space-y-8'>
                        <div className='flex w-full items-start justify-center'>
                            <div className='flex w-1/2 items-center p-8  flex-col justify-center'>
                                <img className="h-48 mx-auto object-cover" src={requirement.getImage()} alt="icon" />
                            ...
                            <div className='flex w-1/2 p-8 items-center justify-start h-full space-y-4 flex-col text-center'>
                                <h2 className="text-2xl font-extrabold items-start text-white">{t('attach_your_files')}</h2>
                                <DropzoneFiles id="files" onChange={handleInputChange} />
                                <FormOutputMessage errors={errors} success={success} />
                            </div>
                        </div>
                        <div className="flex space-x-4 p-8 w-full items-center justify-end">
