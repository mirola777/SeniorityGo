                        ...
                        errors.map((error) => {
                            return (
                                <li className="flex items-center">
                                    <ErrorIcon className="w-5 h-5 mr-4 text-gray-400 flex-shrink-0" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                                    {error}
                                </li>
                            );
                        })
            ...
            {success && (
                <div role="alert" className="rounded border-l-4 border-green-600 bg-gray-700 p-4">
                    <p className="flex items-center text-gray-200">
                        <SuccessIcon className="w-5 h-5 mr-4 text-green-400 flex-shrink-0" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                        {success}
                    </p>
                </div>
            )}
