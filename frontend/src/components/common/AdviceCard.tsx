                    ...
                    <div className="rounded-2xl max-w-lg bg-gradient-to-r from-fuchsia-700 to-blue-600 p-1 shadow-2xl">
                        <div className="transition block rounded-xl duration-150 bg-gray-800/80 p-4 sm:p-6 lg:p-8">
                            <figure className="max-w-screen-md mx-auto text-center">
                                <p className="text-2xl italic font-medium text-gray-900 dark:text-white">{t('advice')}</p>
                                ...
                                <p className="text-lg italic font-medium text-gray-900 dark:text-white">{message}</p>
                            </figure>
                        </div>
                    </div>

                    <div className='flex justify-end pr-4'>
                        <img className='w-[60%] max-w-md' src={PokemonAdvice} />
                    </div>
