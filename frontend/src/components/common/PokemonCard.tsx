...
function PokemonCard({ pokemon }: PokemonCardProps) {
    return (
        <div>
            {pokemon && (
                <div className="h-full transition ease-in-out hover:scale-105 hover:bg-indigo-500 duration-150 rounded-2xl bg-gradient-to-r from-fuchsia-700 to-blue-600 p-0.5 shadow-2xl">
